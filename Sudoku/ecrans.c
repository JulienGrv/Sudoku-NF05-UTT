...
void ecranPrincipal(SDL_Surface *ecran, bool *finDuProgramme)
{
  ...
  // Chargement du bouton "R�soudre une grille"
  ...
  // Transparences
  SDL_SetColorKey(kafraZoom, SDL_SRCCOLORKEY,
                  SDL_MapRGB(kafraZoom->format, 255, 0, 255));
  SDL_SetColorKey(nouvellePartie, SDL_SRCCOLORKEY,
                  SDL_MapRGB(nouvellePartie->format, 255, 0, 255));
  SDL_SetColorKey(chargerPartie, SDL_SRCCOLORKEY,
                  SDL_MapRGB(chargerPartie->format, 255, 0, 255));
  SDL_SetColorKey(resoudreGrille, SDL_SRCCOLORKEY,
                  SDL_MapRGB(resoudreGrille->format, 255, 0, 255));
  SDL_SetColorKey(bulle, SDL_SRCCOLORKEY,
                  SDL_MapRGB(bulle->format, 255, 0, 255));
...
void ecranChoixDifficulte(SDL_Surface *ecran, bool *finDuProgramme)
{
  ...
  SDL_SetColorKey(persoDifficile, SDL_SRCCOLORKEY,
                  SDL_MapRGB(persoDifficile->format, 255, 0, 255));
  SDL_SetColorKey(persoFacile, SDL_SRCCOLORKEY,
                  SDL_MapRGB(persoFacile->format, 255, 0, 255));
  SDL_SetColorKey(persoMoyen, SDL_SRCCOLORKEY,
                  SDL_MapRGB(persoMoyen->format, 255, 0, 255));
  SDL_SetColorKey(difficile, SDL_SRCCOLORKEY,
                  SDL_MapRGB(difficile->format, 255, 0, 255));
  SDL_SetColorKey(facile, SDL_SRCCOLORKEY,
                  SDL_MapRGB(facile->format, 255, 0, 255));
  SDL_SetColorKey(moyen, SDL_SRCCOLORKEY,
                  SDL_MapRGB(moyen->format, 255, 0, 255));
...
void ecranJouer(SDL_Surface *ecran, bool *finDuProgramme, int niveau)
{
  ...
  // Soit on cr�er une nouvelle partie si un niveau a �t� choisi soit on reprend
  ...
  // On affiche les solutions � l'�cran
